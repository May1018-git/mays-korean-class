...
const FLASH_DECKS = [
  ...
  {id:"level2-intermediate",name:"중급2 (Level2 for Intermediate)",words:[
    {word:"건강",meaning:"Health"},{word:"병",meaning:"Illness"},{word:"감기",meaning:"Cold (illness)"},
    {word:"열",meaning:"Fever"},{word:"두통",meaning:"Headache"},{word:"치료",meaning:"Treatment"},
    {word:"수술",meaning:"Surgery"},{word:"약",meaning:"Medicine"},{word:"주사",meaning:"Injection"},
    {word:"환자",meaning:"Patient"},{word:"간호사",meaning:"Nurse"},{word:"응급실",meaning:"Emergency room"},
    {word:"교통",meaning:"Traffic / Transportation"},{word:"사고",meaning:"Accident"},{word:"위험",meaning:"Danger"},
    {word:"안전",meaning:"Safety"},{word:"보호",meaning:"Protection"},{word:"규칙",meaning:"Rule"},
    {word:"질서",meaning:"Order"},{word:"평화",meaning:"Peace"},{word:"전쟁",meaning:"War"},
    {word:"자유",meaning:"Freedom"},{word:"권리",meaning:"Right (entitlement)"},{word:"의무",meaning:"Duty"},
    {word:"책임",meaning:"Responsibility"},{word:"약속하다",meaning:"To promise"},{word:"지키다",meaning:"To protect / keep"},
    {word:"잃다",meaning:"To lose"},{word:"찾다",meaning:"To find / look for"},{word:"얻다",meaning:"To gain / obtain"},
    {word:"만들다",meaning:"To make"},{word:"짓다",meaning:"To build"},{word:"부수다",meaning:"To break / destroy"},
    {word:"고치다",meaning:"To fix"},{word:"깨다",meaning:"To break (something)"},{word:"사용하다",meaning:"To use"},
    {word:"준비하다",meaning:"To prepare"},{word:"시작하다",meaning:"To start"},{word:"끝나다",meaning:"To end"},
    {word:"계속하다",meaning:"To continue"},{word:"멈추다",meaning:"To stop"},{word:"시도하다",meaning:"To try"},
    {word:"포기하다",meaning:"To give up"},{word:"도착하다",meaning:"To arrive"},{word:"출발하다",meaning:"To depart"},
    {word:"떠나다",meaning:"To leave"},{word:"돌아오다",meaning:"To return"},{word:"머무르다",meaning:"To stay"},
    {word:"방문하다",meaning:"To visit"},{word:"초대하다",meaning:"To invite"},{word:"환영하다",meaning:"To welcome"},
    {word:"감사하다",meaning:"To thank / appreciate"},{word:"미안하다",meaning:"To be sorry"},{word:"부끄럽다",meaning:"To be embarrassed"},
    {word:"자랑스럽다",meaning:"To be proud"},{word:"두렵다",meaning:"To be afraid"},{word:"외롭다",meaning:"To be lonely"},
    {word:"그립다",meaning:"To miss"},{word:"즐겁다",meaning:"To be enjoyable"},{word:"답답하다",meaning:"To feel stuffy / frustrated"},
    {word:"시원하다",meaning:"To feel refreshing"},{word:"부드럽다",meaning:"To be soft"},{word:"딱딱하다",meaning:"To be hard"},
    {word:"깨끗하다",meaning:"To be clean"},{word:"더럽다",meaning:"To be dirty"},{word:"조용하다",meaning:"To be quiet"},
    {word:"시끄럽다",meaning:"To be noisy"},{word:"가볍다",meaning:"To be light (weight)"},{word:"무겁다",meaning:"To be heavy"},
    {word:"두껍다",meaning:"To be thick"},{word:"얇다",meaning:"To be thin"},{word:"넓다",meaning:"To be wide"},
    {word:"좁다",meaning:"To be narrow"},{word:"깊다",meaning:"To be deep"},{word:"얕다",meaning:"To be shallow"},
    {word:"가깝다",meaning:"To be near"},{word:"멀다",meaning:"To be far"},{word:"같다",meaning:"To be same"},
    {word:"다르다",meaning:"To be different"},{word:"비슷하다",meaning:"To be similar"},{word:"예술",meaning:"Art"},
    {word:"과학",meaning:"Science"},{word:"기술",meaning:"Technology"},{word:"발명",meaning:"Invention"},
    {word:"연구",meaning:"Research"},{word:"실험",meaning:"Experiment"},{word:"자료",meaning:"Data / Material"},
    {word:"정보",meaning:"Information"},{word:"지식",meaning:"Knowledge"},{word:"경험",meaning:"Experience"},
    {word:"능력",meaning:"Ability"},{word:"재능",meaning:"Talent"},{word:"성격",meaning:"Personality"},
    {word:"태도",meaning:"Attitude"},{word:"습관",meaning:"Habit"},{word:"행동",meaning:"Behavior / Action"},
    {word:"표정",meaning:"Facial expression"},{word:"모양",meaning:"Shape"},{word:"종류",meaning:"Kind / Type"},
    {word:"부분",meaning:"Part / Portion"},
  ]},
];
